...
class Enemy(Player):
    ...
    def shoot(self):
        if self.rect.y in (0, 300, 700):
            ...
            enemybullet.rect.x = self.rect.x + 13
...
class Game:
    ...
    def start_text(self):
        ...
        text = font.render('LALALAT', True, 'blue')
        text_rect = text.get_rect(center=(s_width/2, s_height/2))
        screen.blit(text, text_rect)
        
        font2 = pygame.font.SysFont('Calibri', 20)
        text2 = font2.render('PYGAMEPROJECT2023BYME', True, 'white')
    ...
    def pause_text(self):
        font = pygame.font.SysFont('Calibri', 50)
        text = font.render('GAME PAUSE', True, 'white')
        text_rect = text.get_rect(center=(s_width/2, s_height/2))
        screen.blit(text, text_rect)        
    ...
    def game_over_screen(self):
        ...
        while True:
            ...
            if self.game_over_sound_delay > 1200:
